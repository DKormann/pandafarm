...
export namespace Gift {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: Gift): void {
    Gift.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): Gift {
    return Gift.getTypeScriptAlgebraicType().deserialize(reader);
  }
