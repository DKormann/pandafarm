...
export namespace AnimalActionType {
  ...
  export function serialize(writer: BinaryWriter, value: AnimalActionType): void {
      AnimalActionType.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): AnimalActionType {
      return AnimalActionType.getTypeScriptAlgebraicType().deserialize(reader);
  }
