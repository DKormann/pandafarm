...
import { FollowersTableHandle } from "./followers_table.ts";
export { FollowersTableHandle };
...
import { Follower } from "./follower_type.ts";
export { Follower };
...
const REMOTE_MODULE = {
  tables: {
    followers: {
      tableName: "followers",
      rowType: Follower.getTypeScriptAlgebraicType(),
      primaryKey: "id",
    },
    game_state: {
...
export class RemoteTables {
  ...
  get followers(): FollowersTableHandle {
    return new FollowersTableHandle(this.connection.clientCache.getOrCreateTable<Follower>(REMOTE_MODULE.tables.followers));
  }
